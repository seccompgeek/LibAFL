...
use libafl::{
    ...
    schedulers::{powersched::SchedulerMetadata, testcase_score::DistanceTestCaseScore},
    stages::Stage,
    state::{HasClientPerfMonitor, HasCorpus, HasMetadata, HasNamedMetadata, UsesState},
    Error,
};

use crate::{scheduler::{DistanceSchedulerMetadata, DistanceTestcaseMetadata}, observer};
