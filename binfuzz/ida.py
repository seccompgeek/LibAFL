...
# $IDA_PATH -B "-S$BINSEC_PATH/src/ida/ida.py --output-dir=/output/path --call-graph=True --ida-graph=True /path/to/binary
...
if __name__ == "__main__":
    ...
    basename = os.path.join(output_dir, idc.get_input_file_path())
